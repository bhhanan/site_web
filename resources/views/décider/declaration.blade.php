 ...
 <h1 class="heading">Décider<h1>
    ...
    <div class="form">
             ...
             <div class="input_field">
               ...
               <div class="input_field">
                   <label>Numéro:</label>
                    <input type="number" class="input" name="numéro"/> 
              </div>
              <div class="input_field">
                    <label>Nom:</label>
                ...
                <div class="input_field">
                     <label>Lieu de <br>
                        Décider :</label>
                      <input type="text" class="input" name="lieuDécider"> </input>
                </div> 
                <div class="input_field">
                     <label>date de <br>
                        Décider :</label>
                      <input type="date" class="input" name="dateDécider"> </input>
                </div> 
                <div class="input_field">
    ...
    <div class="form">
              <div class="input_field">
                    <label>Nom:</label>
                    <input type="text" class="input" name="NomPére"/> 
                </div>
                    <div class="input_field">
                       <label>Prénom:</label>
    ...
    <div class="form">
              <div class="input_field">
                    <label>Nom:</label>
                    <input type="text" class="input" name="NomMére"/> 
                </div>
                    <div class="input_field">
                       <label>Prénom:</label>
                      <input type="text" class="input" name=""/> 
